...
def create_rr_rolltables():
    universal_rr = [
        SystemModifier("Ionic Crystal", "", ""),
        SystemModifier("Giga Lattice", "", ""),
        SystemModifier("Amianthoid", "", ""),
        SystemModifier("Mercurite", "", ""),
        SystemModifier("Beryllium", "", ""),
    ]
    unique_bio_rr = [
        SystemModifier("RedSang", "", ""),
        SystemModifier("Bluecap Mold", "", ""),
        SystemModifier("Eden Incense", "", ""),
        SystemModifier("Transvine", "", ""),
        SystemModifier("Superspuds", "", ""),
        SystemModifier("Proto-Orchid", "", ""),
        SystemModifier("Proto-Spores", "", ""),
        SystemModifier("placeholder 01", "", ""),
        SystemModifier("placeholder 02", "", ""),
    ]
    red_rr = [
        SystemModifier("placeholder 11", "", ""),
        SystemModifier("placeholder 12", "", ""),
    ]
    grey_rr = [
        SystemModifier("placeholder 21", "", ""),
        SystemModifier("placeholder 22", "", ""),
    ]
